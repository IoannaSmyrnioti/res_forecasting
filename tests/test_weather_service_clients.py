...
def test_retrieve_and_store_data(requests_mock):
    ...
    mock_url = (
        api_client.base_url
        + "/38.9697,-77.385/2020-10-01?key="
        + str(os.getenv("WEATHER_API_KEY"))
    )
    mock_response = {
        "queryCost": 24,
        "latitude": 38.9697,
        ...
        "days": [
            {
                ...
                "uvindex": 4.0,
                "sunrise": "07:05:56",
                "sunriseEpoch": 1601550356,
                "sunset": "18:51:28",
                "sunsetEpoch": 1601592688,
                "moonphase": 0.5,
        ...
        "stations": {
            "72405503714": {
                ...
                "useCount": 0,
                "id": "72405503714",
                "name": "LEESBURG EXECUTIVE AIRPORT, VA US",
                "quality": 100,
                "contribution": 0.0,
            },
            "KIAD": {
            ...
            "72403093738": {
                ...
                "useCount": 0,
                "id": "72403093738",
                "name": "WASHINGTON DULLES INTERNATIONAL AIRPORT, VA US",
                "quality": 100,
                "contribution": 0.0,
            },
            "C3816": {
            ...
            "72033493764": {
                ...
                "useCount": 0,
                "id": "72033493764",
                "name": "GAITHERSBURG MONTGOMERY CO AIR PARK, MD US",
                "quality": 100,
                "contribution": 0.0,
            },
        },
